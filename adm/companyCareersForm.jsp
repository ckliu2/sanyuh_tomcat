...
<ww:form name="careersForm" action="saveCompanyCareers" method="POST" onsubmit="onSubmit()">
  <ww:hidden name="careers.id" value="${careers.id}"/>
  <ww:hidden name="careers.allow" value="${careers.allow}"/>
  <input type="hidden" name="careers.companyId" value="<ww:property value="#session['user'].id"/>"/>
  
  <table border="0" cellspacing="1" >
    <tr><td class="cContentTitle" colspan="2" ><fmt:message key="careers.form"/></td></tr>
    <tr class="cActionButtonLine">
      <td colspan="2">
        <input type=button onclick="javascript:window.location='companyCareersList.do'" class="cButton" value="<fmt:message key="common.back"/>" >
   ...
   <tr><td class="cInputCaption1"><fmt:message key="careers.company"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">            
            <ww:property value="#session['user'].name"/>            
        </td>
    </tr>
   ...
   <tr><td class="cInputCaption1"><fmt:message key="careers.candidates"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
           <ww:checkboxlist name="candidatesWayIds" 
            ...
            />  
            <span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('careers.candidatesWayIds')"/></span>
        </td>
    </tr>
